  ...
  return (
    <Card className="p-3 mb-3">
      ...
      <CardBody className="ps-2b border-bottom">
        ...
        <h5 className="fw-bold  mb-0 no-margin">{username} non ha post recenti </h5>
        <p className="no-margin">I post recenti condivisi da {username} verranno visualizzati qui.</p>
      </CardBody>
