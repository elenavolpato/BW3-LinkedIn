  ...
  return (
    <div className="post-card">
      ...
      <div className="post-caption">
        <img className="post-img" src="https://placedog.net/50/50" alt="foto profilo" />
      ...
      <div>
        ...
        {showToggle && (
          <Button variant="link" className="post-desc-toggle p-0" onClick={() => dispatch(togglePostExpanded(postId))}>
      ...
      <div>
        {props.img ? (
          <img className="post-media-img" src={props.img} alt="contenuto del post" />
        ) : props.video ? (
          <video className="post-media-video" src={props.video} controls preload></video>
        ) : null}
      </div>
